...
SecurityContext securityContext;
  ...
  //  Principal User = securityContext.getUserPrincipal();
  //
  //  InputStream inputStream = new ByteArrayInputStream(formData.inputStream.readAllBytes());
  //  CompletableFuture<ObjectWriteResponse> owr = minioClient.putObject(PutObjectArgs.builder()
  //      .bucket(User.getName())
